...
public class GameUseCaseFactory {
    ...
    public static GameView create(SearchBarViewModel searchBarViewModel, GuessViewModel guessViewModel, LeaderboardViewModel leaderboardViewModel, ViewManagerModel viewManagerModel) {
        GuessDataAccessInterface playerDataAccessObject = new PlayerDataAccess(new int[]{0,6000,5000,4000,3000,2000,1000});
        ...
        return new GameView(searchBarViewModel, searchBarController, guessViewModel, guessController, skipController);
    }
